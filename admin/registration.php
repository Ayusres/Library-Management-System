...
if(isset($_POST['submit']))
{
  ...
  $sql = "SELECT username FROM admin WHERE LOWER(username) = '$username'";
  ...
  if(mysqli_num_rows($res) == 0)
  {
    ...
    // $query = "INSERT INTO admin (first, last, username, password, email, contact) VALUES ('$first', '$last', '$username', '$password', '$roll', '$email', '$contact')";
