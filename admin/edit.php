...
<body style="background-color:#4699bc;">
	...
	<div class="profile_info" style="text-align:center;">
		...
		<h4 style="color: white;"><?php echo $_SESSION['admin_user'];?></h4>
...
<?php
	if(isset($_POST['submit']))
	{
		$first=$_POST['first'];
			...
			$sql1="UPDATE admin SET first='$first', last='$last',username='$username',password='$password',email='$email',contact='$contact' WHERE username='".$_SESSION['admin_user']."';";
